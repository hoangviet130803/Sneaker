...
<footer class="footer-area pt-85 bg-white pb-90">
    <div class="container">
        ...
        <div class="footer-bottom copyright text-center">
            <p>Copyright © 2022 GROUP 5 | <a href="https://api.memegen.link/images/rollsafe/When_you_have_a_really_good_idea.webp?layout=top">Built with <span>VIRUS</span> by GROUP 5</a>.</p>
        </div>
    </div>
</footer>
