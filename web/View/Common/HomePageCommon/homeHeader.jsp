                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="header-offer-wrap-4 text-center">
                            <p><span class="uppercase">Free shipping</span> worldwide for orders over <span class="amount">199$.</span> <a href="#">Learn More</a></p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="main-menu main-menu-padding-2 main-menu-center main-menu-font-width-400 main-menu-lh-4 main-menu-hover-semibold main-menu-hover-border">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="HomeFooter.jsp">CONTACT </a></li>
